export default function Hero() {
    ...
    <div className="sm:w-[50%] flex justify-center">
       <h3 className="text-center my-5 text-gray-600"><span className="font-bold text-black">pono piece</span> is a local writers group to help each other create thier masterpiece or artifact</h3>
    </div>
      </div>
